...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>';
                document.getElementById('wrapper').appendChild(_self.gearArea);
                areaCtrlInit();
            ...
            _self.getData(function() {
                _self.trigger.addEventListener('touchend', popupArea);
            });
        },
        //重置节点个数
        ...
        close: function(e) {
            ...
            document.getElementById('wrapper').removeChild(_self.gearArea);
            _self.gearArea=null;
        }
    }
    return MobileArea;
